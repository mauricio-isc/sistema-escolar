...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM MATRICULAS WHERE Matricula = '$matricula' AND ID_Coordinacion IS NOT NULL AND contrasena = '$contrasena_encriptada'";
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: ../loginCoordinador.php");
